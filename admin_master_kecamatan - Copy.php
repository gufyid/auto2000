...
<tr>
<td>Kecamatan</td>
<td><input type="text" name="kecamatan" id="kecamatan" size="20" value="<?php echo $data[nama];?>"/></td>
</tr>
...
if(empty($_POST['kota'])){
	...
	if(($_GET['x']!="0"))
	{
				...
				echo "</div>";
				echo "<meta http-equiv=refresh content=2;url=?c=salesman&sub=master&action=kecamatan>";
