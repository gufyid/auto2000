...
<div id="ki"><legend>Kode</legend></div>
<div id="ka"><input type="text" name="kode" id="kode" class="small" value="<?php echo $kode;?>" readonly="readonly"/><input type="hidden" name="kodeh" value="<?php echo $urut;?>"></div>
<div id="divider"></div>
<div id="divider"></div>

<div id="ki">Nama Usaha</div>
<div id="ka"><input type="text" name="nama_usaha" id="nama_usaha" class="small" value="<?php echo $data[nama];?>"/></div>
<div id="divider"></div>
<div id="divider"></div>

<div id="ki">Alamat</div>
<div id="ka"><input type="text" name="alamat" id="alamat" value="<?php echo $data['alamat'];?>"></div>
<div id="divider"></div>
<div id="divider"></div>

<div id="ki">Contact Person</div>
<div id="ka"><input type="text" name="contact" id="contact" class="medium" value="<?php echo $data['contact'];?>"></textarea></div>
<div id="divider"></div>
<div id="divider"></div>
...
<div id="ki">Kota - Kecamatan</div>
<div id="ka"><select name="kota" id="kota" onchange='process_kota()'/>
...
<div id="ki">Tempat Lahir</div>
<div id="ka"><input type="text" name="tempat_lahir" id="tempat_lahir" class="small" value="<?php echo $data[tempat_lahir];?>"/></div>
<div id="divider"></div>
<div id="divider"></div>



<div id="ki">Tgl Lahir</div>
<div id="ka"><input type="text" name="tgl_lahir" id="tgl_lahir" readonly="readonly" value="<?php echo $tgl_lahir;?>"/></div>
<div id="divider"></div>
<div id="divider"></div>
...
<div id="ka"><select name="jenis_usaha" id="jenis_usaha"/>
<option value="" selected="selected">Pilih</option>
<?php
myconn();
...
<div id="ka"><select name="jasa_produksi" id="jasa_produksi"/>
<?php
...
<div id="ka"><select name="prospect_first_cust" id="prospect_first_cust" />
<?php
...
<div id="ki">Tipe</div>
<div id="ka"><select name="tipe" id="tipe"/>
<option value="" selected="selected">Pilih</option>
<?php
myconn();
...
<div id="ki">UIO</div>
<div id="ka"><select name="uio" id="uio"/>
<option value="" selected="selected">Pilih</option>
<?php
myconn();
...
<div id="ka"><select name="decision" id="decision"/>
<?php
if($data['decision']=='1'){
...
<div id="ka"><select name="jenis_badan_usaha" id="jenis_badan_usaha"/>
<option value="" selected="selected">Pilih</option>
<?php
myconn();
...
<div id="ki">Omzet</div>
<div id="ka"><select name="omzet" id="omzet"/>
<option value="" selected="selected">Pilih</option>
<?php
myConn();
...
<div id="ka"><select name="lama_usaha" id="lama_usaha"/>
<option value="" selected="selected">Pilih</option>
<?php
myConn();
...
<div id="ka"><input type="text" name="lokasi_usaha" id="lokasi_usaha" class="medium" value="<?php echo $data[lokasi_usaha];?>"/></div>



<div id="ki">Networking</div>
<div id="ka"><input type="text" name="networking" id="networking" class="small" value="<?php echo $data[networking];?>"/></div>
<div id="divider"></div>
<div id="divider"></div>
