...
<tr>
<td>Kode / NIK</td>
<td><input type="text" name="kode" id="kode" size="25" value="<?php echo $data[kode];?>"/></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
</tr>
</table>
...
<tr>
<td>Nama Salesman</td>
<td><input type="text" name="nama" id="nama" size="50" value="<?php echo $data[nama];?>"/></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
</tr>
...
<tr>
<td>Email</td>
<td><input type="text" name="email" id="email" size="50" value="<?php echo $data[email];?>"/></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
</tr>
