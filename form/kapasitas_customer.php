...
<body>
<div id="tabs-5">
<div id="tabs_kapasitas">
<ul>
<li><a href="#tabs_kapasitas">Data Per Salesman</a></li>
</ul>
<div id="tabs_kapasitas">

<div><label>Salesman</label>&nbsp;&nbsp;<select name="salesman_kapasitas" id="salesman_kapasitas">
...
&nbsp;&nbsp;<input type="button" name="ok" value="Proses" onclick='javascript:process_kapasitas()'>
</div>
<div id="hasil_kapasitas"><center><img src="images/loader.gif"></center></div>
</div>
