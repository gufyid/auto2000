...
<div id="tabs_segmen">
<ul>
<li><a href="#tabs_segmen">Data Per Salesman</a></li>
</ul>
<div id="tabs_segmen">

<div><label>Salesman</label>&nbsp;&nbsp;<select name="salesman_segmen" id="salesman_segmen">
...
&nbsp;&nbsp;<input type="button" name="ok" value="Proses" onclick='javascript:process_segmen()'>
</div>
<div id="hasil_segmen"><center><img src="images/loader.gif"></center></div>
</div>
