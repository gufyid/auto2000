...
<div id="tabs1">
<ul>
<li><a href="#tabs-11">Data Visit Salesman</a></li>
<li><a href="#tabs-12">Grafik 7Step</a></li>
<!--<li><a href="#tabs-13">Coverage Area</a></li>-->
</ul>
<div id="tabs-11">
...
?>
<option value="<?php echo $dtq['kode'];?>"><?php echo $dtq['kode'];?></option>";
<?php
}
?>
</select>
...
<div id="tabs-12">
<input type="submit" name="btx1" value="Tampilkan" onclick="process_grafik_7step()">
<input type="hidden" id="adminh" value="<?php echo $ARSESS[0];?>">
<input type="hidden" id="spvh" value="<?php echo $ARSESS[1];?>">
<div id="hasil_grafik_7step"><center><img src="images/loader.gif"></div>
