...
$strXML = "<graph caption='Data Komposisi Tipe' subCaption='Salesman : $salesman' xAxisName='tipe' yAxisName='Persentasi'>";
}
...
$strXML = "<graph caption='Data Komposisi Tipe' subCaption='Supervisor : $spv' xAxisName='tipe' yAxisName='Persentasi'>";
...
$jum=mysql_fetch_array(mysql_query("select count(*) as jumlah from t_customer where tipe='$dtproduk[id]' and salesman='$salesman'"));
}
}else{
if($salesman=='all'){
$jum=mysql_fetch_array(mysql_query("select count(*) as jumlah from t_customer a
left join t_salesman b on b.kode=a.salesman 
left join t_supervisor c on c.kode=b.spv where a.tipe='$dtproduk[id]' and c.kode='$spv'"));
}else{
$jum=mysql_fetch_array(mysql_query("select count(*) as jumlah from t_customer a
left join t_salesman b on b.kode=a.salesman 
left join t_supervisor c on c.kode=b.spv where a.tipe='$dtproduk[id]' and c.kode='$spv' and a.salesman='$salesman'"));
