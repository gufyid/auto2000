...
$total_kunjungan=mysql_fetch_array(mysql_query("select count(*) as jum from t_kunjungan"));

while($dtq=mysql_fetch_array($q)){	

$jum=mysql_fetch_array(mysql_query("select count(*) as jumlah from t_kunjungan where sevenstep='$dtq[id]'"));
