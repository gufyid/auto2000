...
<td>
<input type="radio" name="pilihan" id="pilihan" value="1" onClick='pilihanmu()'>Customer 1 bulan tidak di kunjungi
<input type="radio" name="pilihan" id="pilihan" value="2" onClick='pilihanmu()'>Customer 3 kali dengan steping sama
<input type="radio" name="pilihan" id="pilihan" value="3" onClick='pilihanmu()'>Waktu service customer
<input type="radio" name="pilihan" id="pilihan" value="4" onClick='pilihanmu()'>Kapasitas customer
<input type="radio" name="pilihan" id="pilihan" value="5" onClick='pilihanmu()'>Komposisi Tipe
<input type="radio" name="pilihan" id="pilihan" value="6" onClick='pilihanmu()'>Segmen Customer
